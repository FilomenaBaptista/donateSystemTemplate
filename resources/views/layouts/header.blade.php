    ...
    <div class="container-fluid d-flex align-items-center justify-content-between">
        ...
        <nav id="navbar" class="navbar">
            <ul>
                ...
                <li><a class="nav-link scrollto" href="voluntario.php">Quero ser Voluntário</a></li>
                <li><a class="nav-link scrollto" href="doacao.php">Solicitar Doações</a></li>
                {{--  <li><a class="nav-link scrollto" href="historia-de-sucesso.php">Histórias de Sucesso</a></li>
